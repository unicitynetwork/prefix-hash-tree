...
describe('Sum-Certifying Tree Example', function() {
  ...
  this.beforeEach(function () {
    const leaves: Leaf[] = [
      { 
        path: 0b100000000n, 
        value: smthash('value-1'), 
        numericValue: 100n 
      },
      { 
        path: 0b100010000n, 
        value: smthash('value-2'), 
        numericValue: 200n 
      },
      { 
        path: 0b101000000n, 
        value: smthash('value-3'),
        numericValue: 300n 
      }
    ];
    
    tree = new SMT(smthash, leaves, true);
  });
  ...
  it('shows working with proofs', function() {
    ...
    assert.deepStrictEqual(
      path.getItems(), 
      [
        { type: "root", rootHash: CryptoJS.enc.Hex.parse("5036fb762516b11bab5ae51302992aadad1b614f75390a61d0dfea9f01eb9a72"), sum: 600n },
        { type: "internalNode", prefix: 16n, siblingHash: undefined, siblingSum: undefined },
        { type: "internalNode", prefix: 4n, siblingHash: CryptoJS.enc.Hex.parse("3e3388924a231e8b932e64be43477becdb937d83f87b3d350f99b6df53053151"), siblingSum: 200n },
        { type: "internalNode", prefix: 5n, siblingHash: CryptoJS.enc.Hex.parse("0231facbbdb1132a3af0e036907d27910971e6915a37cb1d7e7e632a766f97fd"), siblingSum: 100n },
        { type: "leaf", value: CryptoJS.enc.Hex.parse("93f9c50853d1ba7b4dc6244a2a64b2f427cd612ae34a3cad638ef5bc14cc7ecb"), numericValue: 300n }]);
