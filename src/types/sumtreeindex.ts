...
export interface SumPathItemInternalNodeHashed
  extends AbstractPathItemInternalNodeHashed {
...
export interface ISumPathItemInternalNodeHashedJson
  extends ISumPathItemJsonBase {
